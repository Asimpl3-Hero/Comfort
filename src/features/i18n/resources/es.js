export const es = {
  ...
  cart: {
    ...
    itemQuantity: 'Cantidad: {{count}}',
    itemStock: 'Stock disponible: {{count}}',
    unitPrice: 'Precio unitario: {{price}}',
    itemSubtotal: 'Subtotal: {{total}}',
    qtyStock: 'Cant: {{quantity}} | Stock: {{stock}}',
    items: 'Articulos: {{count}}',
    totalItems: 'Total de unidades: {{count}}',
    total: 'Total: {{total}}',
  ...
  checkout: {
    ...
    summary: {
      ...
      cartItems: 'Unidades en carrito',
      productQuantity: 'Cantidad seleccionada: {{count}}',
      unitPrice: 'Precio unitario: {{price}}',
      productSubtotal: 'Subtotal producto',
